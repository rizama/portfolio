<?php namespace App\Http\Controllers;
	...
	class AdminProfilesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|email|unique:profiles','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Language','name'=>'language','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Social','name'=>'social','type'=>'text','validation'=>'required|min:1','width'=>'col-sm-10'];
